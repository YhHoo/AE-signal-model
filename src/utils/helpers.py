...
def picklist_multiple_timeseries_2(input, subplot_titles, main_title):
    '''
    WARNING: FOR 7 CHANNELS
    This fn is designed for manual filtering of the LCP, selected by detect_ae_event_by_v_sensor().
    Aspect axis[0] of input is 8(sensors), axis[1] is time steps. All time series has to be
    SAME length !
    :param input: a 2d-array / list
    ...
    # discard button
    flag = {}
    # start of segmentation for (-5.4m, -2m, 2m, 5m, 8m, 17m)
    segment_head = [600, 0, 0, 1100, 2700, 4000, 5300]
