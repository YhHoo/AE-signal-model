...
from src.utils.helpers import load_model, evaluate_model_for_all_class, break_into_train_test, \
...
model = load_model(model_name='PLB_2018_7_13_Classification_CNN[33k]_take2')
