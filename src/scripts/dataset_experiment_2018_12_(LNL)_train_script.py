...
# ------------------------------------------------------------------------------------------------------------ DATA PREP
ae_data = AcousticEmissionDataSet(drive='F')
train_x, train_y, test_x, test_y = ae_data.random_leak_noleak_dec_july_no_norm(train_split=0.7)
