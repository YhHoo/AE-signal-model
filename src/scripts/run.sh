...
declare -a all_even_channel=(0 1 2 3 4 5 6 7)

declare -a sample_vector_size=6000

declare -a downsample_factor=10


echo ------------------------------------------------------------------------------------------- leak [0]
python dataset_experiment_2018_10_3_\(LeakRandom\)_data_preparation_script.py --fts "${file_to_save[0]}" --ftr "${folder_to_read[0]}" --cth ${all_even_channel[2]} --svs 6000 --dsf 10

echo ------------------------------------------------------------------------------------------- noleak [0]
python dataset_experiment_2018_10_3_\(LeakRandom\)_data_preparation_script.py --fts "${file_to_save[1]}" --ftr "${folder_to_read[1]}" --cth ${all_even_channel[2]} --svs 6000 --dsf 10

echo ------------------------------------------------------------------------------------------- leak [-4,-2,2,4,6,8,10]
python dataset_experiment_2018_10_3_\(LeakRandom\)_data_preparation_script.py --fts "${file_to_save[2]}" --ftr "${folder_to_read[2]}" --cth ${all_even_channel[*]} --svs 6000 --dsf 10

echo ------------------------------------------------------------------------------------------- noleak [-4,-2,2,4,6,8,10]
python dataset_experiment_2018_10_3_\(LeakRandom\)_data_preparation_script.py --fts "${file_to_save[3]}" --ftr "${folder_to_read[3]}" --cth ${all_even_channel[*]} --svs 6000 --dsf 10
