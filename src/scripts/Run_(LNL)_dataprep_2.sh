...
echo ------------------------------------------------------------------------------------------- leak [0]
python dataset_experiment_2018_10_3_\(LeakRandom\)_data_preparation_script_2.py --fts "${file_to_save[0]}" \
...
python dataset_experiment_2018_10_3_\(LeakRandom\)_data_preparation_script_2.py --fts "${file_to_save_2[0]}" \
