...
DIR_TO_SAVE_PRED_CSV_SEEN_LEAK = 'G:/Experiment_3_1_2019/LNL_model_Evaluation_Result/{} evaluate with Experiment_2018_1_3_SEEN_LEAK_Test data/'.format(MODEL_NAME_TO_TEST)
DIR_TO_SAVE_PRED_CSV_UNSEEN_LEAK = 'G:/Experiment_3_1_2019/LNL_model_Evaluation_Result/{} evaluate with Experiment_2018_1_3_UNSEEN_LEAK_Test data/'.format(MODEL_NAME_TO_TEST)
DIR_TO_SAVE_PRED_CSV_SEEN_NOLEAK = 'G:/Experiment_3_1_2019/LNL_model_Evaluation_Result/{} evaluate with Experiment_2018_1_3_SEEN_NOLEAK_Test data/'.format(MODEL_NAME_TO_TEST)
DIR_TO_SAVE_PRED_CSV_UNSEEN_NOLEAK = 'G:/Experiment_3_1_2019/LNL_model_Evaluation_Result/{} evaluate with Experiment_2018_1_3_UNSEEN_NOLEAK_Test data/'.format(MODEL_NAME_TO_TEST)
DIR_TO_SAVE_CM_SEEN_LEAK = 'C:/Users/YH/Desktop/hooyuheng.master/MASTER_PAPERWORK/My Practical Work------------/Preprocessed Dataset recognition result/LNL model (dataset Dec)/{} evaluate with Jan 2019 SEEN_LEAK Test data/'.format(MODEL_NAME_TO_TEST)
DIR_TO_SAVE_CM_SEEN_NOLEAK = 'C:/Users/YH/Desktop/hooyuheng.master/MASTER_PAPERWORK/My Practical Work------------/Preprocessed Dataset recognition result/LNL model (dataset Dec)/{} evaluate with Jan 2019 SEEN_NOLEAK Test data/'.format(MODEL_NAME_TO_TEST)
DIR_TO_SAVE_CM_UNSEEN_LEAK = 'C:/Users/YH/Desktop/hooyuheng.master/MASTER_PAPERWORK/My Practical Work------------/Preprocessed Dataset recognition result/LNL model (dataset Dec)/{} evaluate with Jan 2019 UNSEEN_LEAK Test data/'.format(MODEL_NAME_TO_TEST)
DIR_TO_SAVE_CM_UNSEEN_NOLEAK = 'C:/Users/YH/Desktop/hooyuheng.master/MASTER_PAPERWORK/My Practical Work------------/Preprocessed Dataset recognition result/LNL model (dataset Dec)/{} evaluate with Jan 2019 UNSEEN_NOLEAK Test data/'.format(MODEL_NAME_TO_TEST)
