...
all_file_path = all_file_path[38:58]
...
ae_data.generate_leak_1bar_in_cwt_xcor_maxpoints_vector(saved_filename='sliced_xcor_2_p3', file_to_process=all_file_path)
