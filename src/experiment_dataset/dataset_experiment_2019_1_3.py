...
class AcousticEmissionDataSet:
    ...
    def __init__(self, drive):
        ...
        # No Normalized & No Downsample (6000 points per sample) -------------------------------------------------------
        # leak
        ...
        # No Normalized & No Downsample (2000 points per sample) --------------------------------------------
        # seen leak
        self.leak_dataset_filename_p1_2 = self.drive + 'Experiment_3_1_2019/leak_noleak_preprocessed_dataset/' \
                                                        'dataset_leak_random_1.5bar_[-4,-2,2,4,6,8,10]_2.csv'
        self.leak_dataset_filename_p2_2 = self.drive + 'Experiment_3_1_2019/leak_noleak_preprocessed_dataset/' \
                                                        'dataset_leak_random_1.5bar_[0]_2.csv'

        # seen no leak
        self.noleak_dataset_filename_p1_2 = self.drive + 'Experiment_3_1_2019/leak_noleak_preprocessed_dataset/' \
                                                          'dataset_noleak_random_1.5bar_[-4,-2,2,4,6,8,10]_2.csv'
        self.noleak_dataset_filename_p2_2 = self.drive + 'Experiment_3_1_2019/leak_noleak_preprocessed_dataset/' \
                                                          'dataset_noleak_random_1.5bar_[0]_2.csv'

        # unseen leak
        self.leak_dataset_filename_p3_2 = self.drive + 'Experiment_3_1_2019/leak_noleak_preprocessed_dataset/' \
                                                        'dataset_leak_random_1.5bar_[-3,5,7,16,17]_2.csv'
        # unseen no leak
        self.noleak_dataset_filename_p3_2 = self.drive + 'Experiment_3_1_2019/leak_noleak_preprocessed_dataset/' \
                                                          'dataset_noleak_random_1.5bar_[-3,5,7,16,17]_2.csv'
    ...
    def random_leak_noleak_include_unseen(self, shuffle_b4_split=True, train_split=0.7):
        '''
        Sampling rate of 1MHz, but include unseen in validation
        '''
        print('DATASET: 2019-1-3 random_leak_noleak_downsampled_include_unseen()\n')
        # read leak @ -4, -2, 2, 4, 6, 8, 10m
        time_start = time.time()
        print('Reading --> ', self.leak_dataset_filename_p1_2)
        df_leak_rand_p1 = pd.read_csv(self.leak_dataset_filename_p1_2)
        ...
        # read leak @ 0m
        time_start = time.time()
        print('Reading --> ', self.leak_dataset_filename_p2_2)
        df_leak_rand_p2 = pd.read_csv(self.leak_dataset_filename_p2_2)
        ...
        # read noleak @ -4, -2, 2, 4, 6, 8, 10m
        time_start = time.time()
        print('Reading --> ', self.noleak_dataset_filename_p1_2)
        df_noleak_rand_p1 = pd.read_csv(self.noleak_dataset_filename_p1_2)
        ...
        # read noleak @ 0m
        time_start = time.time()
        print('Reading --> ', self.noleak_dataset_filename_p2_2)
        df_noleak_rand_p2 = pd.read_csv(self.noleak_dataset_filename_p2_2)
        ...
        time_start = time.time()
        print('Reading --> ', self.noleak_dataset_filename_p3_2)
        df_noleak_rand_p3 = pd.read_csv(self.noleak_dataset_filename_p3_2)
        ...
        time_start = time.time()
        print('Reading --> ', self.leak_dataset_filename_p3_2)
        df_leak_rand_p3 = pd.read_csv(self.leak_dataset_filename_p3_2)
        print('File Read Time: {:.4f}s'.format(time.time() - time_start))
...
# data1 = data.random_leak_bydist_downsampled_4()
